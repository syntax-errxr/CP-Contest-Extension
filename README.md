...
*   **`install_dependencies.bat`** – Run this **first and only once**. It automatically downloads and installs all necessary packages, configures your database, and builds the extension.
*   **`run_project.bat`** – Run this to start the backend server in a command window. Keep it open in the background while using the extension.
...
### Step 3: Start the Backend & Load the Extension
